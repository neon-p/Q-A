                    ...
                    <div class="bg-white p-10 mb-15">
                        ...
                        <div class="post">
                            <form action="php/edit_profile.php" method="post">
                                <label>Title</label>
                                <input type="text" name="title" value="<?php echo $row1["question_title"];?>" class="form-control" require>
                                <br>
                                <label>Body</label>
                                <textarea rows="8" class="form-control" name="q_body" require><?php echo $row1["question_body"]; ?></textarea>
                                <br>
                                <input type="hidden" name="qus_id" value="<?php echo $q_id;?>">
                                <button type="submit" name="save_question" class="btn btn-success">Save</button>
                            </form>
                        </div>
                    </div>
                    <?php
